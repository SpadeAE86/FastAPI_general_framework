...
if __name__ == "__main__":
    ...
    # Overlay times (from real run logs)
    times = [
    ...
    for idx, cfg in enumerate(audio_configs):
        stream_idx = idx + 15  # WAV files start at input index 15
    ...
    out_file = "./work/mix_7176/debug_out.mp4"
    ...
    print("Running FFmpeg command and capturing output...")
